...
$sql="SELECT tblstudent.StuID,tblstudent.StudentName,tblstudent.Course,tblstudent.StudentEmail,tblstudent.DateofAdmission from tblstudent LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->Course);?> <?php  echo htmlentities($row->Section);?></td>
