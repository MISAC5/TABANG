...
$sql="update tblusers set FullName=:fname,UserName=:uname,Password=:password where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Manage User</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Manage User</h4>
...
{               ?>  
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="password" value="<?php  echo htmlentities($row->Password);?>" class="form-control" required='true'>
                      </div>
                      <?php $cnt=$cnt+1;}} ?>
