...
$totteacher=$query5->rowCount();
?>
                          <span class="report-title">Total Teachers</span>
                          <h4><?php echo htmlentities($totteacher);?></h4>
                          <a href="manage-teachers.php"><span class="report-count"> View Teachers</span></a>
                        </div>
                        <div class="inner-card-icon bg-success">
                          <i class="icon-rocket"></i>
                        </div>
...
$query5->execute();
$results5=$query5->fetchAll(PDO::FETCH_OBJ);
$totusers=$query5->rowCount();
?>
                          <span class="report-title">Total Users</span>
                          <h4><?php echo htmlentities($totusers);?></h4>
                          <a href="manage-users.php"><span class="report-count"> View Users</span></a>
                        </div>
                        <div class="inner-card-icon bg-primary">
                          <i class="icon-doc"></i>
                        </div>
