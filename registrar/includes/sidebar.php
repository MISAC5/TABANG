...
{               ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="manage-course.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth2">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="files/transor.php"> Transcript of Records </a></li>
                  <li class="nav-item"> <a class="nav-link" href="files/soa.php"> Statement of Account </a></li>
                </ul>
              </div>
            </li>
              <li class="nav-item">
