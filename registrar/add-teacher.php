...
$sql="insert into tblteacher(TeacherName,TeacherEmail,TeacherCourse,Gender,DOB,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:tchname,:tchemail,:tchclass,:gender,:dob,:connum,:altconnum,:address,:uname,:password,:image)";
$query=$dbh->prepare($sql);
$query->bindParam(':tchname',$tchname,PDO::PARAM_STR);
$query->bindParam(':tchemail',$tchemail,PDO::PARAM_STR);
$query->bindParam(':tchclass',$tchcourse,PDO::PARAM_STR);
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Teacher Course</label>
                        <select  name="tchcourse" class="form-control" required='true'>
...
{          
    ?>  
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->CourseCode);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                        </select>
                      </div>
                      <div class="form-group">
