...
if (strlen($_SESSION['sturecmsaid']==0)) {
   ...
   if(isset($_POST['submit']))
  {
    ...
    $cdean=$_POST['cdean'];
    $cdate=$_POST['cdate'];
$sql="insert into tblcourses(CourseCode,CourseDescription,Dean,CreationDate)values(:ccode,:cname,:cdean,:cdate)";
...
echo "<script>window.location.href ='add-subjectsf.php'</script>";
  }
  else
    {
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="cdean" value="" class="form-control" required='true'>
                      </div>
