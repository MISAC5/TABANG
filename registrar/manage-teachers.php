                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Course Assignment</th>
...
$sql="SELECT tblteacher.TeacherName,tblteacher.TeacherEmail,tblteacher.TeacherCourse from tblteacher LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                  <tr>
                    ...
                    <td><?php  echo htmlentities($row->TeacherCourse);?></td>
