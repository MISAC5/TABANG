            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="tor.php"> Transcript of Records </a></li>
                  <li class="nav-item"> <a class="nav-link" href="soa.php"> Statement of Account </a></li>
                  <li class="nav-item"> <a class="nav-link" href="personalgrades.php"> Grades </a></li>
                </ul>
              </div>
            </li>
