                ...
                <div class="table-responsive border rounded p-1">
                      ...
                      <h5>FIRST YEAR, 1st Semester</h5>
                        ...
                        <tbody>
                            ...
                            $sql1="SELECT tblsubjects.SubjectCode, tblsubjects.SubjectDescription, tblsubjects.CollegiateYear, tblsubjects.Semester ,tblsubjects.Units from tblsubjects where Semester = '1st' AND CollegiateYear = 'FIRST YEAR'";
...
<br>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql2="SELECT tblsubjects.SubjectCode, tblsubjects.SubjectDescription, tblsubjects.CollegiateYear, tblsubjects.Semester ,tblsubjects.Units from tblsubjects where Semester = 'SUMMER' AND CollegiateYear = 'FIRST YEAR'";
