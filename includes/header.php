    ...
    <div class="header" id="home">
      <nav class="navbar navbar-default">
        <div class="container">
          ...
          <h1><a class="navbar-brand" href="index.php" style = "margin-top: 1vh; margin-left: 2vw;">HCCB</a></h1>
          </div>
          <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
                ...
                <li><a href="registrar/login.php"><span data-hover="Contact">Registrar</span></a></li>
                <li><a href="user/studlogin.php"><span data-hover="Shortcodes">Student</span></a></li>
